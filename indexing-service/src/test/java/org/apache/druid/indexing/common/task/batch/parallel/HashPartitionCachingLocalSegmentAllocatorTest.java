...
public class HashPartitionCachingLocalSegmentAllocatorTest {
	...
	private static final HashedPartitionsSpec PARTITIONS_SPEC = new HashedPartitionsSpec(null, null,
	...
	public void setup() throws IOException {
		...
		target = SegmentAllocators.forNonLinearPartitioning(toolbox, DATASOURCE, TASKID,
				...
				SupervisorTaskAccessWithNullClient.mockSupervisorTaskAccess1(SUPERVISOR_TASKID), partitionAnalysis);
	...
	public void allocatesCorrectShardSpec() throws IOException {
		...
		Assert.assertEquals(SegmentId.of(DATASOURCE, INTERVAL, VERSION, PARTITION_NUM),
	...
	private static InputRow createInputRow() {
		...
		return new MapBasedInputRow(timestamp, Collections.singletonList(DIMENSION), ImmutableMap.of(DIMENSION, 1));
	}
}
