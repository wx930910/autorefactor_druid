...
public class NamespacedExtractorModuleTest {
	...
	public void setUp() throws Exception {
		final Map<Class<? extends ExtractionNamespace>, CacheGenerator<?>> factoryMap = ImmutableMap.of(
				UriExtractionNamespace.class,
				new UriCacheGenerator(ImmutableMap.of("file", new LocalFileTimestampVersionFinder())),
		...
		scheduler = new CacheScheduler(noopServiceEmitter, factoryMap, new OnHeapNamespaceExtractionCacheManager(
	...
	public void testNewTask() throws Exception {
		...
		final UriExtractionNamespace namespace = new UriExtractionNamespace(tmpFile.toURI(), null, null,
