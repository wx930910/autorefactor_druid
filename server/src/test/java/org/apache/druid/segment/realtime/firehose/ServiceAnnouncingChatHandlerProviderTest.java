...
public class ServiceAnnouncingChatHandlerProviderTest extends EasyMockSupport {
	static public ChatHandler mockChatHandler1() {
		ChatHandler mockInstance = Mockito.spy(ChatHandler.class);
		try {
	...
	public void testRegistrationWithoutAnnounce() {
		ChatHandler testChatHandler = ServiceAnnouncingChatHandlerProviderTest.mockChatHandler1();
